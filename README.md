...
```sh
  cd my-folder
  git clone https://github.com/paulinagonzalezc/bookstore-react.git
```
...
Feel free to check the [issues page](https://github.com/paulinagonzalezc/bookstore-react/issues).
